...
class AjaxRouter extends Router
{
  ...
  protected function initiate_controller()
  {
    ...
    $this->route->class = ATAConfig::$plugin_namespace . "\\" . $this->route->class;
  ...
  protected function set_prefix()
  {
    ...
    if (isset($this->route->guest) && $this->route->guest === true)
      $this->prefix = ATAConfig::$wp_ajax_guest_action_prefix;
    else
      $this->prefix = ATAConfig::$wp_ajax_action_prefix;
  }
}
